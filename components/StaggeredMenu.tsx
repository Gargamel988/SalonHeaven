  ...
  return (
    ...
    >
      <div
        ...
        style={accentColor ? ({ ['--sm-accent' as keyof React.CSSProperties]: accentColor } as React.CSSProperties) : undefined}
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-white z-50 "
          style={isFixed ? { pointerEvents: 'auto' } : { pointerEvents: 'none' }}
        ...
        <aside
          ...
          style={{ WebkitBackdropFilter: 'blur(12px)', pointerEvents: 'auto' }}
          aria-hidden={!open}
        >
      ...
      <style>{`
.sm-scope .staggered-menu-wrapper { position: relative; width: 100%; height: 100%; z-index: 0; }
.sm-scope .staggered-menu-header { position: absolute; top: 0; left: 0; width: 100%; display: flex; align-items: center; justify-content: space-between; padding: 2em; z-index: 20; }
